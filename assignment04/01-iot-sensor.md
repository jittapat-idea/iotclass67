...
2. MPU6050 : ตรวจจับการเคลื่อนไหว
3. HTS221 : วัดอุณหภูมิและความชื้น
...
โดย
1. สีเขียว: แสดงสถานะเริ่มต้นการทำงานของ board
2. สีนํ้าเงิน: แสดงสถานะเชื่อมต่อ Wifi สำเร็จ
3. สีเหลือง: แสดงสถานะเชื่อมต่อ MQTT สำเร็จ
4. สีขาว(กะพริบ) :แสดงว่า board ของเรากำลังส่งข้อมูลออก
5. สีแดง :แสดงสถานะว่ามี error เกิดขึ้นเช่น เชื่อม MQTT ไม่สำเร็จ
6. สีเเดง(กะพริบ) :แสดงสถานะว่าเชื่อมต่อ WiFi ไม่สำเร็จ
...
โดยใช้ไลบรารี ESPNtpClient ซึ่งช่วยให้การตั้งค่าและรับเวลา NTP จากเซิร์ฟเวอร์ (ใช้เซิร์ฟเวอร์ NTP ของเราเอง "172.16.46.11")
